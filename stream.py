...
st.set_page_config(page_title ="P111 Group 2",
                    page_icon="🔮")

#Title and other text details
st.title('Gold Price Prediction')
st.write('This project enables you to generate time series prediction of Gold Price. It is developed by: ')
st.write('Mentors: Kartik and Dhanyapriya')
st.write('Team P111-Group 2: Gourangee, Rahul, Arman, Parul, Nirali, Prathik')
